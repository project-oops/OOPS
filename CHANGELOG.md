...
- **`bin/oops`**, one entry point for six repositories. `bootstrap` fetches the siblings a
...
- **`docs/CONVENTIONS.md`**, stated once for all six repositories rather than six times
